package com.dragon.oc.avatar.creator.ui.add_character
...
import com.dragon.oc.avatar.creator.core.extensions.hideSoftKeyboard
...
import com.dragon.oc.avatar.creator.core.helper.BitmapHelper
...
import com.dragon.oc.avatar.creator.data.model.draw.Draw
import com.dragon.oc.avatar.creator.data.model.draw.DrawableDraw
import com.dragon.oc.avatar.creator.databinding.ActivityAddCharacterBinding
import com.dragon.oc.avatar.creator.dialog.ChooseColorDialog
import com.dragon.oc.avatar.creator.dialog.DialogSpeech
import com.dragon.oc.avatar.creator.dialog.DialogType
import com.dragon.oc.avatar.creator.dialog.YesNoDialog
import com.dragon.oc.avatar.creator.listener.listenerdraw.OnDrawListener
import com.dragon.oc.avatar.creator.ui.add_character.adapter.BackgroundColorAdapter
import com.dragon.oc.avatar.creator.ui.add_character.adapter.BackgroundImageAdapter
import com.dragon.oc.avatar.creator.ui.add_character.adapter.StickerAdapter
...
class AddCharacterActivity : BaseActivity<ActivityAddCharacterBinding>() {
    ...
    private fun setupKeyboardLogging() {
        ViewCompat.setOnApplyWindowInsetsListener(binding.root) { view, insets ->
            ...
            Log.d(
                "EditTextFlow",
                "scvText.scrollY=${binding.scvText.scrollY}, scvText.canScrollVertically(1)=${
                    binding.scvText.canScrollVertically(1)
                }, scvText.canScrollVertically(-1)=${binding.scvText.canScrollVertically(-1)}"
            )
...
//                        isFocusEditText
    ...
    override fun viewListener() {
        binding.apply {
            ...
            edtText.onFocusChangeListener = View.OnFocusChangeListener { _, hasFocus ->
                ...
                Log.d(
                    "EditTextFlow",
                    "scvText.scrollY=${binding.scvText.scrollY}, scvText.height=${binding.scvText.height}"
                )
                if (hasFocus) {
            ...
            stickerAdapter.onItemClick = { path -> viewModel.checkDataInternet(this@AddCharacterActivity, action={addDrawable(path)}) }
    ...
    private fun setupSelectedTabBackground(
        ...
        focusImage.setImageResource(R.drawable.frame_item)
    ...
    private fun setupUnselectedTabBackground(
        ...
        focusImage.setImageResource(R.drawable.unslt_tab)
    ...
    private fun setupTypeNavigation(type: Int) {
        ...
        binding.apply {
            ...
            if (isBackground) titleBackground.gone() else titleBackground.gone()
