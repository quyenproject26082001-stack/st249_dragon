package com.dragon.oc.avatar.creator.core.custom.text
...
class StrokeTextView : AppCompatTextView {
    ...
    private var isOuterStroke = false
    ...
    fun setOuterStroke(widthPx: Float, color: Int) {
        strokeWidth = widthPx * 2f
        strokeColor = color
        strokeJoin = Join.ROUND
        strokeMiter = 5f
        isOuterStroke = true
    ...
    override fun onDraw(canvas: Canvas) {
        if (isOuterStroke && strokeWidth > 0f) {
            val fillColor = this.currentTextColor
