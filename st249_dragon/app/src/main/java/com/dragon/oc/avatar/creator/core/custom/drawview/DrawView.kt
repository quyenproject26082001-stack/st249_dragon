package com.dragon.oc.avatar.creator.core.custom.drawview
...
import com.dragon.oc.avatar.creator.data.model.draw.DrawDraw
import com.dragon.oc.avatar.creator.data.model.draw.DrawableDraw
import com.dragon.oc.avatar.creator.data.model.draw.TextDraw
import com.dragon.oc.avatar.creator.listener.listenerdraw.BitmapDrawIcon
import com.dragon.oc.avatar.creator.listener.listenerdraw.DeleteEvent
import com.dragon.oc.avatar.creator.listener.listenerdraw.FlipEvent
import com.dragon.oc.avatar.creator.listener.listenerdraw.OnDrawListener
import com.dragon.oc.avatar.creator.listener.listenerdraw.ZoomEvent
...
//                }
    ...
    private fun setupDefaultIcons() {
        ...
        val flipIcon = BitmapDrawIcon(
            resizeDrawableToDp(ContextCompat.getDrawable(context, R.drawable.ic_flip_cs)!!, 28), DrawKey.TOP_LEFT
        )
