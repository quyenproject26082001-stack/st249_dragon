...
import com.dragon.oc.avatar.creator.ui.customize.CustomizeCharacterActivity
...
import com.dragon.oc.avatar.creator.databinding.ActivityChooseCharacterBinding
...
class ChooseCharacterActivity : BaseActivity<ActivityChooseCharacterBinding>() {
    ...
    private fun checkInternetForAPICharacters(data: ArrayList<com.dragon.oc.avatar.creator.data.model.custom.CustomizeModel>) {
