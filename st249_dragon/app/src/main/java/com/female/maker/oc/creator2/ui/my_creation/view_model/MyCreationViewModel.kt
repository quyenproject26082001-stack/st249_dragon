package com.female.maker.oc.creator2.ui.my_creation.view_model
...
import com.female.maker.oc.creator2.core.helper.StringHelper
import com.female.maker.oc.creator2.core.utils.share.telegram.TelegramSharing
import com.female.maker.oc.creator2.core.utils.share.whatsapp.IdGenerator
import com.female.maker.oc.creator2.core.utils.share.whatsapp.StickerBook
import com.female.maker.oc.creator2.core.utils.share.whatsapp.StickerPack
...
class MyCreationViewModel : ViewModel() {
    ...
    private val _hasAvatarItems = MutableStateFlow(false)
    val hasAvatarItems: StateFlow<Boolean> = _hasAvatarItems

    fun setHasAvatarItems(hasItems: Boolean) {
        _hasAvatarItems.value = hasItems
    }
