...
import com.female.maker.oc.creator2.databinding.ActivityChooseCharacterBinding
...
class ChooseCharacterActivity : BaseActivity<ActivityChooseCharacterBinding>() {
    ...
    private fun checkInternetForAPICharacters(data: ArrayList<com.female.maker.oc.creator2.data.model.custom.CustomizeModel>) {
    ...
    override fun initActionBar() {
        binding.actionBar.apply {
            ...
            setTextActionBar(tvCenter, getString(R.string.list_girl_school))
            tvCenter.select()
        }
    }
